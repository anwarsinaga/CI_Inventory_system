                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Tambahkan Lokasi Inventory</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form  action="<?php echo site_url('admin/itemstore/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">                            
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Lokasi</label><small class="req"> *</small>
            ...
            ?>">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Daftar Lokasi Inventaris</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body  ">
